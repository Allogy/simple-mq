...
public final class MessageQueueService {
     ...
     *
     * @param queueName - the name of the queue
     * @param config    - an instance of {@link com.npstrandberg.simplemq.config.PersistentMessageQueueConfig}
     *                  or {@link com.npstrandberg.simplemq.config.MessageQueueConfig}
     * @return a message queue
     */
